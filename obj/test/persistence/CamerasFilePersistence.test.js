...
const CamerasFilePersistence_1 = require("../../src/persistence/CamerasFilePersistence");
const CamerasPersistenceFixture_1 = require("./CamerasPersistenceFixture");
suite('CamerasFilePersistence', () => {
    let persistence;
    let fixture;
    setup(() => __awaiter(void 0, void 0, void 0, function* () {
        persistence = new CamerasFilePersistence_1.CamerasFilePersistence();
        persistence.configure(pip_services3_commons_nodex_1.ConfigParams.fromTuples("path", "./data/cameras.test.json"));
...
//# sourceMappingURL=CamerasFilePersistence.test.js.map